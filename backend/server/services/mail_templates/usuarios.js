function newMember(data) {
    ...
    <a href="${data.origin}/auth/new-member?token=${data.token}"> Registrarse </a>
    `
...
function restorePwd(data) {
    ...
    <a href="${data.origin}/auth/restore-password?token=${data.token}"> Restaurar contraseña. </a>
    `
...
function newUsuario(data) {
    ...
    <a href="${data.origin}/auth/confirmar-cuenta?token=${data.token}"> Confirmar cuenta. </a>
    `
