...
module.exports = {
  up: async function (queryInterface, Sequelize) {
    ...
    //   { id: 0, descripcion: "Root", is_admin: true, permisos: '{"equipo": {"icon": "groups", "slug": "/point/user/equipo"}, "ventas": {"icon": "payments", "slug": "/point/user/ventas"}, "notificaciones": {"icon": "notifications", "slug": "/point/user/notificaciones"}}', estatus: true },
    //   { id: 10, descripcion: "Administrador", is_admin: true, permisos: '{"equipo": {"icon": "groups", "slug": "/point/user/equipo"}, "ventas": {"icon": "payments", "slug": "/point/user/ventas"}, "notificaciones": {"icon": "notifications", "slug": "/point/user/notificaciones"}}', estatus: true },
    //   { id: 11, descripcion: "Empleado", is_admin: false, permisos: '{"equipo": {"icon": "groups", "slug": "/point/user/equipo"}, "ventas": {"icon": "payments", "slug": "/point/user/ventas"}, "notificaciones": {"icon": "notifications", "slug": "/point/user/notificaciones"}}', estatus: true },
    // ], {});

    // await queryInterface.bulkInsert({ tableName: 'ca_equipos', schema: schema }, [
    //   { id: -9999, nombre: "Admin" },
    ...
    //   { id: -1, id_rol: 0, id_equipo: -9999, nombre: "root", contrasenia: "de88e3e4ab202d87754078cbb2df6063", correo: "root@correo.com", estatus: true },
