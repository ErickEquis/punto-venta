...
@NgModule({
  declarations: [HomeUsersPageComponent, EquipoPageComponent, VentasPageComponent, ModalEditVentaComponent, ModalAddMemberComponent, NotificacionesPageComponent, ModalNotificacionComponent, ModalHistorialComponent],
  imports: [
    CommonModule,
    UsersRoutingModule,
    FormsModule,
